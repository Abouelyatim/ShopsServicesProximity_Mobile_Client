...
class AddressAdapter (
    ...
    class AddressHolder(
        ...
        fun bind(item: Address) = with(itemView) {
            itemView.address_city.text=item.city
            itemView.address_street.text=item.street
            itemView.address_house_number.text=item.houseNumber.toString()
            itemView.address_zip_code.text=item.zipCode.toString()
